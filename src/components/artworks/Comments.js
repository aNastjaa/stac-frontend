    ...
    return _jsxs("div", {
        ...
        children: [
            _jsx("ul", {
                ...
                children: comments.slice(0, showAllComments ? comments.length : 3).map((comment) =>
                    _jsx("li", {
                        children: _jsxs("div", {
                            className: "comment",
                            children: [
                                _jsxs("strong", {
                                    children: [comment.user?.username || "Loading comment...", ":"]
                                }),
                                " ",
                                comment.comment_text,

                                // Show delete button only if the user owns the comment
                                ownerships[comment.id] && _jsx("button", {
            ...
            comments.length > 3 && !showAllComments && _jsx("button", {
            ...
            _jsxs("div", {
                ...
                children: [
                    ...
                    _jsx("button", {
                        ...
                        children: _jsx(Send, { size: 24, color: "#e3e3e3" })
                    })
                ]
            })
        ]
