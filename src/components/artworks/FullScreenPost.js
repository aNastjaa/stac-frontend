        ...
        _jsxs("div", {
            ...
            children: [
                _jsx("button", {
                    ...
                    onClick: onClose,
                    children: _jsx(X, { size: 36, color: "#e3e3e3" }),
                }),
                _jsxs("div", {
                    className: "post-header",
                    children: [
                        avatarUrl ? (
                            _jsx("img", { src: avatarUrl, alt: `${post.username}'s avatar`, className: "avatar" })
                        ) : (
                            _jsx(CircleUserRound, { color: "#131313", size: 80 })
                        ),
                        _jsxs("div", {
                            children: [
                                _jsx("p", { className: "username", children: post.username }),
                                _jsxs("p", {
                                    className: "theme-name",
                                    children: ["Theme: ", post.themeName],
                                }),
                            ],
                        }),
                    ],
                ...
                _jsx("div", {
                    ...
                    children: _jsx("img", { src: post.imageUrl, alt: "Post content" }),
                }),
                _jsxs("div", {
                    className: "post-decription-delete-button",
                    children: [
                        post.description && (
                            _jsx("div", { className: "fullpost-description", children: _jsx("p", { children: post.description }) })
                        ),
                        isPostOwner && (
                            _jsx("div", {
                ...
                _jsxs("div", {
                    ...
                    children: [
                        _jsxs("div", {
                            className: "icon-container-full-post",
                            ...
                            children: [
                                ...
                                _jsx("span", { className: "icon-count", children: likesCount }),
                            ],
                        }),
                        _jsxs("div", {
                            className: "icon-container-full-post",
                            style: { display: "flex", alignItems: "center" },
                            children: [
                                _jsx(MessageCircle, { size: 26, color: "#e3e3e3" }),
                                _jsx("span", { className: "icon-count", children: commentsCount }),
                            ],
                        }),
                    ],
                }),
