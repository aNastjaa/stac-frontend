...
const ArtWorks = () => {
    ...
    return (_jsxs("div", { className: "artwork-page", children: [selectedArtwork && (_jsx(FullScreenPost, { post: {
                ...
                onPostDeleted: handlePostDeleted })), 
                    _jsxs("section", { className: "artwork-submit-section", 
                        children: [_jsxs("h1", { className: "current-theme-title", 
                            children: ["Current Theme: ", _jsx("br", {}), " ", _jsx("span", { className: "current-theme-name", 
                                children: currentTheme ? currentTheme.theme_name : 'Loading...' })] }), _jsxs("p", { className: "current-theme-description", 
                                    children: ["This month\u2019s theme is all about the color yellow! ", _jsx("br", {}), _jsx("br", {}), " Whether it\u2019s in a painting, a photo, or even 3D art, we want to see how you bring yellow to life in your own creative way. ", _jsx("br", {}), _jsx("br", {}), "Show us yellow in its many forms\u2014bright, bold, and beautiful. Let your imagination run wild!"] }), 
                                    _jsx(ButtonLong, { onClick: () => setShowForm(true), text: "Submit" })] }), 
                                    showForm && (_jsx("div", { className: "modal-overlay", 
                                        children: _jsxs("div", { className: "modal-content", 
                                            children: [_jsx("button", { className: "close-button", onClick: () => setShowForm(false), 
                                                children: "\u00D7" }), _jsx("h2", { children: "Submit Your Artwork" }), 
                                                _jsxs("form", { onSubmit: handleSubmit, className: "artwork-submit-form", 
                                                    children: [_jsxs("div", { className: "form-group artwork-image", 
                                                        children: [_jsx("label", { className: "form-label", onClick: handleIconClick, 
                                                            children: _jsx(ImagePlus, { size: 50, color: "#131313", className: "image-icon" }) }), _jsxs("p", { className: "icon-explanation", 
                                                                children: ["Click on the icon ", _jsx("br", {}), "to choose a photo"] }), _jsx("input", { ref: fileInputRef, type: "file", id: "file-input", className: "form-input", "data-testid": "file-input", onChange: (e) => setImageFile(e.target.files ? e.target.files[0] : null), style: { display: 'none' } }), imageFile && _jsx("img", { src: URL.createObjectURL(imageFile), alt: "Preview", className: "image-preview" })] }), _jsxs("div", { className: "form-group-artwork-description", children: [_jsx("label", { className: "form-label", children: "Add description:" }), _jsxs("div", { className: "artwork-textarea-container", children: [_jsx("textarea", { value: description, onChange: (e) => setDescription(e.target.value), placeholder: "Enter artwork description", className: "form-textarea" }), _jsx("button", { className: "info-button", onClick: (e) => {
                                                        e.preventDefault();
                                                        setShowInfo(true);
                                                    }, "aria-label": "Show information", children: _jsx(Info, { size: 20, color: "#888" }) })] })] }), errorMessage && _jsx("p", { className: "error-message", children: errorMessage }), successMessage && _jsx(SuccessModal, { message: successMessage }), _jsx("div", { className: "form-group", children: _jsx(ButtonCTA, { text: "Submit Artwork", link: "#", onClick: handleSubmit }) }), showInfo && (_jsx("div", { className: "info-modal", children: _jsxs("div", { className: "info-modal-content", children: [_jsx("button", { className: "info-close-button", onClick: () => setShowInfo(false), children: "\u00D7" }), _jsx("p", { children: "When you submit an artwork, it will be reviewed to ensure it matches the current theme. After approval, your artwork will appear on Artwork page for everyone to admire! But you can always find your artwork in your profile" })] }) }))] })] }) })), _jsxs("section", { className: "this-month-artworks", children: [_jsx("h2", { className: "section-title", children: "This Month's Artworks" }), _jsxs("div", { className: "artworks-gallery", children: [loading ? (_jsx(DotLoader, {})) : (visibleArtworks.length === 0 && _jsx("p", { className: "no-artworks", children: "No artworks available." })), visibleArtworks
