...
export const fetchBrandLogoUrl = async (logoId) => {
    try {
...
export const deleteSponsorChallenge = async (challengeId) => {
    try {
...
export const createTheme = async (themeName, startDate) => {
    try {
        // First, ensure the CSRF token is set
        await setCsrfCookie();
        // Get the CSRF token from the cookie
...
export const updateTheme = async (themeId, themeName, startDate) => {
    try {
...
export const archiveTheme = async (themeId) => {
    try {
        // Ensure the CSRF token is set
        await setCsrfCookie();
        // Get the CSRF token from the cookie
...
// Get archiver themes
export const fetchArchivedThemes = async () => {
    try {
        // Ensure the CSRF token is set
        await setCsrfCookie();
        // Get the CSRF token from the cookie
        ...
        const archivedThemes = await response.json();
